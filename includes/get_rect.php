...
if(isset($_GET['id'])) {
    ...
    $detailsQuery = "SELECT rect.recm_id, product.name,  rect.height, rect.width, rect.sq_ft, rect.qty,rect.total
                    FROM rect, product
    ...
    if ($detailsResult->num_rows > 0) {
        ...
        echo '<tr><th>Product Name</th><th>Height</th><th>Width</th><th>Sq Ft</th><th>Qty</th><th>Total</th></tr>';
