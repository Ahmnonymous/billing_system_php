...
<body>
    <div class="container mt-4 text-center">
        <h2><?php echo isset($expense) ? 'Edit Receiving Amount' : 'Add Receiving Amount'; ?></h2>
        <hr class="my-4">
        
        <!-- expense Input Form -->
        <form action="<?php echo isset($expense) ? 'includes/update_reca.php' : 'includes/save_reca.php'; ?>" method="post">
        ...
        <?php } ?>
            ...
            <div class="form-group text-center">
                <button type="submit" class="btn btn-primary mt-4">Save Receiving</button>
            </div>
        </form><br>
        ...
        <div class="container mt-4 text-center">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    $sql = "SELECT id, name, amount FROM reca";
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            ...
                            echo '<td><a href="reca.php?id=' . $row['id'] . '">Edit</a></td>';
                            echo '</tr>';
                        }
                    } else {
                        echo '<tr><td colspan="3">No amounts found</td></tr>';
                    }
